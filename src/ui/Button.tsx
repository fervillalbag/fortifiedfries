...
export const buttonVariants = cva(
  "font-sans font-medium w-full h-16 rounded-md bg-[#7A7A7A] flex items-center justify-center text-xl focus:ring-2 focus:border-@sura-primary focus:ring-transparent",
  {
    variants: {
      variant: {
        default:
