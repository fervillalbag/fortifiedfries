export default function Card({ ticket }: any) {
  return (
    <button className="w-full text-left rounded-md gap-x-[10px] p-[5px] grid grid-cols-[60px_1fr] border border-@sura-primary-200">
      <div className="">
        <img
      ...
      <div className="flex flex-col justify-between h-full">
        <div>
          <div>
            ...
            <span className="uppercase text-yellow-500 text-xs font-semibold block">
              {ticket.status}
            </span>
          </div>
            ...
            <div>
              ...
              >
                <path
                  ...
                  fill="#1C2331"
                />
                <line y1="13.5" x2="10" y2="13.5" stroke="#1C2331" />
                <line
                  x1="4"
                  y1="10.5"
                  x2="14"
