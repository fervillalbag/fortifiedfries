...
export default function Navbar() {
  ...
  return (
    <div
      className={`shadow-md shadow-@sura-primary-600/50 m-3 z-20 bottom-3 left-0 fixed w-[calc(100%_-_24px)] h-[64px] rounded-lg bg-@sura-primary-50 transition-opacity duration-300`}
    >
